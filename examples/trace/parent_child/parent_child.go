...
func main() {
	...
	ctx, rootSpan := client.StartSpan(ctx, "root_span", "main_span", nil)
	...
	go llmRunner.asyncRending(rootSpan)
...
func (r *llmRunner) llmCall(ctx context.Context) (err error) {
	// llmCall span is child of rootSpan by ctx
